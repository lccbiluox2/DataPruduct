...
function gotoPageNum( offset ){
	...
	window.location.href = "/messageIndexController/preAddMessagePage?currentPage=" + offset;
}
	...
	<div id="messageContent" >
		<div id="messageContent_div" >
			<div id="messageContent_div_div" >
				...
				<br/>
				<p>发表你的留言</p>
				<form action="/messageIndexController/addMessage" method="post">
					<p>
					<textarea 	name="m_content" id="textarea" cols="120" rows="10"></textarea>
					</p>
					<p>
				...
				<#list pageBean.recordList as message> 
					...
					<div style="float:left;width:100%;color:#EC5CA4;">${message.user_name?if_exists} 第${message.id?if_exists}楼</div>
